<?php
require("modulos/biotest/phpToPDF.php"); 
                                      ...
                                      <h2 id=\"CondicionTitulo\" class=\"text-center\" >IMM</h2>  
                                          <div class=\"Resultados2 col-sm-4 col-xs-4\">
                                                ...
                                                <div class=\"Resultados col-sm-4 col-xs-4 pull-right\">
                                                    ...
                                                    <!--Resultados Finales -->
                                                	<div class=\"col-sm-12  col-xs-12 Cintura pull-left\">
                                                    	<label for=\"\" id=\"\" class=\"text-center col-sm-12 col-xs-12\">
														". $ResCintura."</label>
                                                     </div>
                                                    <div class=\"col-sm-12  col-xs-12 Cadera pull-left\">
                                                    	<label for=\"\" id=\"\" class=\"text-center col-sm-12 col-xs-12\">
														". $Res_Cadera."</label>
                                                     </div>
                                                    <div class=\"col-sm-12  col-xs-12 Per_Espalda  pull-left\">
                                                    	<label for=\"\" id=\"\" class=\"text-center col-sm-12 col-xs-12\">
														". $Res_per_esp."</label>
                                                    </div>
                                                    <div class=\"col-sm-12  col-xs-12 Per_Pecho   pull-left\">
                                                    	<label for=\"\" id=\" \" class=\"text-center col-sm-12 col-xs-12\">
														". $Res_pecho ."</label>
                                                     </div>
                                                    <div class=\"col-sm-12  col-xs-12 Per_Brazo pull-left\">
                                                    	<label for=\"\" id=\"\" class=\"text-center col-sm-12 col-xs-12\">
														". $Res_Brazo."</label>
                                                     </div>
                                                    <div class=\"col-sm-12  col-xs-12 Per_Brazo_Fle pull-left\">
                                                    	<label for=\"\" id=\"\" class=\"text-center col-sm-12 col-xs-12\">
														". $Res_BrazoFle."</label>
                                                     </div>
                                                    <div class=\"col-sm-12  col-xs-12 Perimetro_femoral pull-left\">
                                                    	<label for=\"\" id=\"\" class=\"text-center col-sm-12 col-xs-12\">
														". $Res_PeriFemo."</label>
                                                     </div>
